  ...
  return (
    <main className="lg:pl-[260px] min-h-screen bg-slate-50">
      <div className="pt-16 lg:pt-0">
        {/* Header */}
        <div className="bg-gradient-to-r from-violet-600 to-blue-700 px-6 py-10">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl font-black text-white mb-2">Find Your University</h1>
            <p className="text-violet-200 mb-6">Browse {universities.length}+ US colleges with rankings, costs, and outcomes data.</p>
            <div className="flex gap-3 max-w-2xl">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white text-gray-900 placeholder-gray-400 shadow-lg focus:outline-none focus:ring-2 focus:ring-violet-300"
                />
              ...
              <button
                ...
                className={cn("flex items-center gap-2 px-5 py-3 rounded-2xl font-semibold text-sm transition-all shadow-lg",
                  showFilters ? "bg-white text-violet-700" : "bg-white/20 text-white border border-white/30 hover:bg-white/30"
                )}
              >
