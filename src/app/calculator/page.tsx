  ...
  return (
    <main className="lg:pl-[260px] min-h-screen bg-slate-50">
      <div className="pt-16 lg:pt-0">
        {/* Header */}
        <div className="bg-gradient-to-r from-emerald-600 to-blue-600 px-6 py-10">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-3 mb-2">
              <Calculator className="w-8 h-8 text-white" />
              <h1 className="text-3xl font-black text-white">College Cost Calculator</h1>
            </div>
            <p className="text-emerald-200">Calculate the real cost, financial aid, loan burden, and ROI of your college choice.</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-violet-600 rounded-2xl p-5 text-white">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-blue-200">Total Aid Received</span>
